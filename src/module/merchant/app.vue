...
<div class="verify-phone">
    ...
    <div class="isKeeper">
        <input type="radio" value="true" v-model="picked"><label>店长</label>
        <input type="radio" value="false" v-model="picked"><label>店员</label>
    </div>
